# Многостраничный лендинг для магазина SitDownPls
...
## Структура сайта
`http://localhost:3000` - Главная страница магазина
`http://localhost:3000/catalog.html` - Страница с каталогом товаров
`http://localhost:3000/detail.html` - Детальная страница товара
